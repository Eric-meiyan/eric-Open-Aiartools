...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const titles = {
    en: "Blog - Photo Editor Art | AI Image Editing Tips & News",
    zh: "博客 - Photo Editor Art | AI图像编辑技巧与新闻"
  }
  
  const descriptions = {
    en: "Discover the latest AI image editing tips, tutorials, and news from Photo Editor Art. Learn how to transform your images with artificial intelligence.",
    zh: "探索来自Photo Editor Art的最新AI图像编辑技巧、教程和新闻。学习如何用人工智能变换您的图像。"
  }
  ...
  const blogPostsConfig = [
    {
      ...
      sortDate: "2025-06-01",
      image: "/images/Get in Touch with Photo Editor Art Team.png"
    },
    {
      key: "editingGuide",
      link: `/${locale}/blog/how-to-edit-images`,
      sortDate: "2025-06-01",
      image: "/images/How to Edit Images with Photo Editor Art.png"
    },
    {
      key: "introduction",
