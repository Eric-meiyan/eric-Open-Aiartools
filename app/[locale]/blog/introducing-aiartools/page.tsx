...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const titles = {
    en: "Introducing Photo Editor Art: Transform Your Images with AI | Photo Editor Art Blog",
    zh: "Photo Editor Art介绍：用AI的力量改变你的图像 | Photo Editor Art 博客"
  }
  
  const descriptions = {
    en: "Discover Photo Editor Art, the revolutionary AI-powered image transformation platform. Edit and transform images using simple text prompts with cutting-edge AI technology.",
    zh: "发现Photo Editor Art，革命性的AI驱动图像转换平台。使用尖端AI技术，通过简单的文本提示编辑和转换图像。"
  }
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://www.photo-editor.art/${locale}/blog/introducing-aiartools`,
      siteName: "Photo Editor Art",
      locale: locale === 'zh' ? 'zh_CN' : 'en_US',
      type: 'article',
      images: [
        {
          url: 'https://www.photo-editor.art/images/Transform Your Photos with the Power of AI.png',
          width: 1000,
          height: 500,
    ...
    twitter: {
      ...
      title,
      description,
      images: ['https://www.photo-editor.art/images/Transform Your Photos with the Power of AI.png'],
    },
    alternates: {
      canonical: `https://www.photo-editor.art/${locale}/blog/introducing-aiartools`,
      languages: {
        'en': 'https://www.photo-editor.art/en/blog/introducing-aiartools',
        'zh': 'https://www.photo-editor.art/zh/blog/introducing-aiartools',
      },
    },
  }
}
  ...
  const t = (key: string) => {
    const translations: Record<string, Record<string, string>> = {
      en: {
        ...
        title: "Introducing Photo Editor Art: Transform Your Images with the Power of AI",
        ...
        howItWorksText: "Using Photo Editor Art is incredibly simple:",
        ...
        useCases: "Use Cases",
        useCasesText: "Photo Editor Art can be used in countless creative ways:",
        ...
        gettingStartedText: "Ready to transform your images with Photo Editor Art? Getting started is easy:",
        ...
        conclusionText:
          "Photo Editor Art represents the future of image editing – where complex technical skills are replaced by simple, natural language instructions. We're just getting started, and we have an exciting roadmap of new features and capabilities planned for the coming months.",
        conclusionText2:
        ...
        tryItNow: "Try Photo Editor Art Now",
      },
      zh: {
        backToHome: "返回首页",
        backToBlog: "返回博客",
        title: "Photo Editor Art介绍：用AI的力量改变你的图像",
        ...
        howItWorks: "工作原理",
        howItWorksText: "使用Photo Editor Art非常简单：",
        step1: "1. 上传您的图像",
        ...
        useCases: "使用场景",
        useCasesText: "Photo Editor Art可以在无数创意方式中使用：",
        useCase1: "• 社交媒体内容创作",
        ...
        gettingStarted: "入门指南",
        gettingStartedText: "准备好用Photo Editor Art转换您的图像了吗？入门很简单：",
        ...
        conclusion: "结论",
        conclusionText:
          "Photo Editor Art代表了图像编辑的未来——复杂的技术技能被简单、自然的语言指令所取代。我们才刚刚开始，我们计划在未来几个月内推出令人兴奋的新功能和能力。",
        conclusionText2:
          "我们邀请您加入我们的旅程，体验AI驱动的图像转换的魔力。立即注册并开始创建仅受您想象力限制的图像。",
        tryItNow: "立即试用Photo Editor Art",
      },
    }
