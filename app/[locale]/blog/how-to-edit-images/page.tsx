...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const titles = {
    en: "Complete Guide: How to Edit Images with Photo Editor Art | AI Image Editing Tutorial",
    zh: "完整指南：如何使用Photo Editor Art编辑图片 | AI图像编辑教程"
  }
  
  const descriptions = {
    en: "Learn how to edit and transform images using Photo Editor Art. Complete step-by-step tutorial with tips, techniques, and examples for AI-powered image editing.",
    zh: "学习如何使用Photo Editor Art编辑和变换图片。包含AI驱动图像编辑的技巧、技术和示例的完整分步教程。"
  }
  ...
  const t = (key: string): any => {
    const translations: Record<string, Record<string, any>> = {
      en: {
        ...
        title: "Complete Guide: How to Edit Images with Photo Editor Art",
        publishDate: "June 1, 2025",
        readTime: "8 min read",
        category: "Tutorial",
        introduction: "Getting Started with AI Image Editing",
        introText:
          "Welcome to the complete guide on how to edit images using Photo Editor Art! Whether you're a beginner or looking to improve your AI image editing skills, this comprehensive tutorial will walk you through everything you need to know to create stunning image transformations.",
        ...
        conclusionText:
          "With these techniques and tips, you're ready to create stunning image transformations using Photo Editor Art. Remember, the key to success is experimentation and practice. Don't be afraid to try different prompts and approaches – that's how you'll discover the most creative possibilities!",
        conclusionText2:
        ...
        tryNow: "Try Photo Editor Art Now",
      },
      zh: {
        backToHome: "返回首页",
        backToBlog: "返回博客",
        title: "完整指南：如何使用Photo Editor Art编辑图片",
        publishDate: "2025年6月1日",
        readTime: "8分钟阅读",
        category: "教程",
        introduction: "AI图像编辑入门",
        introText:
          "欢迎来到使用Photo Editor Art编辑图片的完整指南！无论您是初学者还是想要提高AI图像编辑技能，这个全面的教程将引导您了解创建令人惊叹的图像变换所需的一切知识。",
        stepByStep: "分步教程",
        ...
        conclusionText:
          "有了这些技术和技巧，您已经准备好使用Photo Editor Art创建令人惊叹的图像变换。记住，成功的关键是实验和练习。不要害怕尝试不同的提示词和方法——这就是您发现最具创意可能性的方式！",
        conclusionText2: "准备将这些技术付诸实践了吗？前往我们的演示部分，开始用AI的力量变换您的图像。",
        tryNow: "立即试用Photo Editor Art",
      },
    }
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mb-10 rounded-xl overflow-hidden">
                <Image
                  src="/images/How to Edit Images with Photo Editor Art.png"
                  alt="How to Edit Images with Photo Editor Art"
                  width={1000}
                  height={500}
