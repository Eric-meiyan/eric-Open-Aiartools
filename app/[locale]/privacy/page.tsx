...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const titles = {
    en: "Privacy Policy - Photo Editor Art | AI-Powered Image Transformation",
    zh: "隐私政策 - Photo Editor Art | AI驱动的图像变换工具"
  }
  
  const descriptions = {
    en: "Learn how Photo Editor Art protects your privacy and handles your personal information. Our commitment to data security and transparency.",
    zh: "了解Photo Editor Art如何保护您的隐私并处理您的个人信息。我们对数据安全和透明度的承诺。"
  }
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://www.photo-editor.art/${locale}/privacy`,
    ...
    alternates: {
      canonical: `https://www.photo-editor.art/${locale}/privacy`,
      languages: {
        'en': 'https://www.photo-editor.art/en/privacy',
        'zh': 'https://www.photo-editor.art/zh/privacy',
      },
    },
  }
}
  ...
  const t = (key: string): string | string[] => {
    const translations: Record<string, Record<string, string | string[]>> = {
      en: {
        ...
        introduction:
          "Welcome to Photo Editor Art (we, our, or us). We are committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our AI-powered image transformation service.",
      ...
      zh: {
        ...
        introduction:
          "欢迎使用Photo Editor Art（我们、我们的或我们）。我们致力于保护您的隐私并确保您个人信息的安全。本隐私政策说明了当您使用我们的AI驱动图像变换服务时，我们如何收集、使用、披露和保护您的信息。",
