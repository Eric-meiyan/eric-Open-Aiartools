...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const titles = {
    en: "Cookie Policy - Photo Editor Art | AI-Powered Image Transformation",
    zh: "Cookie政策 - Photo Editor Art | AI驱动的图像变换工具"
  }
  
  const descriptions = {
    en: "Learn about how Photo Editor Art uses cookies to enhance your experience. Understand our cookie types, security measures, and how to manage your preferences.",
    zh: "了解Photo Editor Art如何使用Cookie来增强您的体验。了解我们的Cookie类型、安全措施以及如何管理您的偏好。"
  }
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://www.photo-editor.art/${locale}/cookies`,
    ...
    alternates: {
      canonical: `https://www.photo-editor.art/${locale}/cookies`,
      languages: {
        'en': 'https://www.photo-editor.art/en/cookies',
        'zh': 'https://www.photo-editor.art/zh/cookies',
      },
    },
  }
}
  ...
  const t = (key: string) => {
    const translations: Record<string, Record<string, string | string[]>> = {
      en: {
        ...
        howWeUseCookiesText:
          "Photo Editor Art uses cookies to enhance your experience on our website and service. We use cookies for the following purposes:",
        cookieUsesList: [
      ...
      zh: {
        ...
        howWeUseCookiesText: "Photo Editor Art使用Cookie来增强您在我们网站和服务上的体验。我们将Cookie用于以下目的：",
        cookieUsesList: [
