...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const titles = {
    en: "Terms of Service - Photo Editor Art | AI-Powered Image Transformation",
    zh: "服务条款 - Photo Editor Art | AI驱动的图像变换工具"
  }
  
  const descriptions = {
    en: "Read our terms of service for using Photo Editor Art. Understand your rights, responsibilities, and our service conditions.",
    zh: "阅读我们使用Photo Editor Art的服务条款。了解您的权利、责任和我们的服务条件。"
  }
  ...
  const t = (key: string): string | string[] => {
    const translations: Record<string, Record<string, string | string[]>> = {
      en: {
        ...
        acceptanceText:
          'By accessing and using Photo Editor Art ("Service"), you accept and agree to be bound by the terms and provisions of this agreement. If you do not agree to abide by the above, please do not use this service.',
        serviceDescTitle: "Description of Service",
        serviceDescText: "Photo Editor Art is an AI-powered image transformation service that allows users to:",
        serviceFeatures: [
      ...
      zh: {
        ...
        acceptanceText:
          '通过访问和使用Photo Editor Art（"服务"），您接受并同意受本协议条款和条件的约束。如果您不同意遵守上述条款，请不要使用此服务。',
        serviceDescTitle: "服务描述",
        serviceDescText: "Photo Editor Art是一个AI驱动的图像变换服务，允许用户：",
        serviceFeatures: [
          "上传图像进行AI驱动的编辑和变换",
          "使用文本提示应用各种风格、滤镜和修改",
          "下载高分辨率的处理图像",
